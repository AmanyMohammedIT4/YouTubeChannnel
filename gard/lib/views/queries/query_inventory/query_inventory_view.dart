...
import 'package:gard/views/queries/query_inventory/query_inventory_scan_view.dart';
import 'package:gard/views/widgets/bar_widget.dart';
import 'package:gard/views/widgets/custom_Text.dart';
import 'package:get/get.dart';

class QueryInventoryView extends StatelessWidget {
                                      ...
                                      children: [
                                        TableRow(
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: (){
                                                  Get.to(()=>QueryInventoryScanView(
                                                    invName: controller.inventoryModel[dataIndex].InvName!,));
